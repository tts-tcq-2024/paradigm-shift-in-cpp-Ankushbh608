...
bool batteryIsOk(float temperature, float soc, float chargeRate) {
    ...
    std::cout << translateStatusToMessage("Temperature", tempBreachStatus, tempWarningStatus) << std::endl;
    std::cout << translateStatusToMessage("State of Charge", socBreachStatus, socWarningStatus) << std::endl;
    std::cout << translateStatusToMessage("Charge Rate", chargeRateBreachStatus, chargeRateWarningStatus) << std::endl;
